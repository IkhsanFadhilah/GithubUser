...
class FollowsAdapt : ListAdapter<ItemsItem, FollowsAdapt.ViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: FollowsAdapt.ViewHolder, position: Int) {
